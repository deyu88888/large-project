    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_type', models.CharField(choices=[('Misconduct', 'Misconduct'), ('System Issue', 'System Issue'), ('Society Issue', 'Society Issue'), ('Event Issue', 'Event Issue'), ('Feedback', 'Feedback'), ('Other', 'Other')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_description', models.CharField(default='', max_length=300)),
                ('cover_image', models.ImageField(default='default-event/event.jpeg', upload_to='event_covers/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='news_icons/newspaper.jpg', null=True, upload_to='society_news/images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Approved', 'Approved'), ('Rejected', 'Rejected'), ('Cancelled', 'Cancelled'), ('Superseded_Approved', 'Superseded (Previously Approved)'), ('Superseded_Rejected', 'Superseded (Previously Rejected)')], default='Pending', max_length=20)),
                ('requested_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_requests', to='api.event')),
                ('hosted_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_requests', to='api.society')),
                ('from_student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)ss', to='api.student')),
            ],
            options={
                'abstract': False,
