# Generated by Django 5.1.2 on 2025-01-30 17:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_requests', to='api.student')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='student',
            name='president_of',
            field=models.ManyToManyField(blank=True, related_name='presidents', to='api.society'),
        ),
        migrations.AddField(
            model_name='student',
            name='societies',
