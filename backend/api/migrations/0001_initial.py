# Generated by Django 5.1.2 on 2025-01-29 12:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, help_text='Student to fill in additional details', max_length=200, null=True)),
                ('intent', models.CharField(choices=[('CreateSoc', 'Create Society'), ('UpdateSoc', 'Update Society'), ('CreateEve', 'Create Event'), ('UpdateEve', 'Update Event')], max_length=10)),
                ('society', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='society_requests', to='api.society')),
                ('from_student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='api.student')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='EventRequest',
            fields=[
                ('societyrequest_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='api.societyrequest')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_requests', to='api.event')),
            ],
            options={
                'abstract': False,
            },
            bases=('api.societyrequest',),
        ),
    ]
