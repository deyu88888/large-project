# Generated by Django 5.1.5 on 2025-03-31 21:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(default="default_description", max_length=150),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cover_image",
                    models.ImageField(
                        default="default-event/event.jpeg", upload_to="event_covers/"
                    ),
                ),
                (
                    "date",
                    models.DateField(default=api.models_files.event_models.get_date),
                ),
                (
                    "start_time",
                    models.TimeField(default=api.models_files.event_models.get_time),
                ),
                (
                    "duration",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "icon",
                    models.ImageField(
                        blank=True, null=True, upload_to="student_icons/"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file_value",
                    models.FileField(
                        blank=True, null=True, upload_to="event_modules_files/"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="read_report_replies",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "target_multiple_societies",
                    models.ManyToManyField(
                        blank=True, related_name="multi_society_news", to="api.society"
                    ),
                ),
                (
                    "target_society",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "events",
                    models.ManyToManyField(
                        blank=True, related_name="broadcasts", to="api.event"
                    ),
                ),
                (
                    "societies",
                    models.ManyToManyField(
                        blank=True, related_name="broadcasts", to="api.society"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        default="news_icons/newspaper.jpg",
                        null=True,
                        upload_to="society_news/images/",
                    ),
                ),
                (
                    "attachment",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="attendees", to="api.event"
            ),
        ),
        migrations.AddField(
            model_name="student",
        ...
        migrations.AddField(
            ...
            name="societies",
            field=models.ManyToManyField(
                blank=True, related_name="members", to="api.society"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="societies_belongs_to", to="api.student"
            ),
        ),
        migrations.AddField(
            model_name="society",
