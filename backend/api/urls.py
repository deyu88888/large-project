...
from .views import (
    ...
    EventModulesView, StudentSocietyListView, SocietyMemberListView
)
...
urlpatterns = [
    ...
    path("student/<int:student_id>/society/", StudentSocietyListView.as_view()),
    path("society/<int:society_id>/member/", SocietyMemberListView.as_view()),
]