...
class TestAdminRestoreView(APITestCase, URLPatternsTestCase):
    ...
    urlpatterns = [
        path('admin/restore/<int:log_id>', AdminRestoreView.as_view(), name='restore'),
    ]
    ...
    def test_restore_unauthorized_user(self):
        ...
        restore_url = reverse('restore', kwargs={'log_id': self.student_delete_log.id})
    ...
    def test_restore_admin_by_regular_admin(self):
        ...
        restore_url = reverse('restore', kwargs={'log_id': self.admin_delete_log.id})
        response = self.client.post(restore_url)
    ...
    def test_restore_student_update_by_admin(self):
        ...
        restore_url = reverse('restore', kwargs={'log_id': self.student_update_log.id})
        response = self.client.post(restore_url)
    ...
    def test_restore_with_approve_action(self):
        ...
        restore_url = reverse('restore', kwargs={'log_id': self.approval_log.id})
        response = self.client.post(restore_url)
    ...
    def test_restore_with_invalid_json_data(self):
        ...
        restore_url = reverse('restore', kwargs={'log_id': self.invalid_data_log.id})
        response = self.client.post(restore_url)
    ...
    def test_restore_with_unsupported_action(self):
        ...
        restore_url = reverse('restore', kwargs={'log_id': self.unsupported_action_log.id})
        response = self.client.post(restore_url)
