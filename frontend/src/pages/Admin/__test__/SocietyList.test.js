...
describe('Society List Page', () => {
    ...
    test('should render society list page', async () => {
        render(_jsx(ThemeProvider, { theme: createTheme(), children: _jsx(SearchContext.Provider, { value: { searchTerm: '', setSearchTerm: vi.fn() }, children: _jsx(MemoryRouter, { initialEntries: ['/admin/society-list'], children: _jsx(Routes, { children: _jsx(Route, { path: "/admin/society-list", element: _jsx(SocietyList, {}) }) }) }) }) }));
