...
describe('ReportReply', () => {
    ...
    it('shows loading state initially', async () => {
        ...
        render(_jsx(MemoryRouter, { initialEntries: ['/admin/report-list/123/reply'], children: _jsx(Routes, { children: _jsx(Route, { path: "/admin/report-list/:reportId/reply", element: _jsx(ReportReply, {}) }) }) }));
