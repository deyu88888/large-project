...
describe('AdminReportList Component', () => {
    ...
    const setup = async (searchTerm = '', useDarkTheme = false) => {
        ...
        let renderResult;
        await act(async () => {
            renderResult = render(_jsx(ThemeProvider, { theme: useDarkTheme ? darkTheme : theme, children: _jsx(SearchContext.Provider, { value: contextValue, children: _jsx(MemoryRouter, { children: _jsx(AdminReportList, {}) }) }) }));
