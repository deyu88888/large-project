...
import { 
  ...
  fetchReportReplies
} from '../fetchReports'; // Update the path to your actual file
...
describe('Report API Functions', () => {
  ...
  describe('fetchReports', () => {
    it('fetches reports successfully', async () => {
      ...
      (apiClient.get as vi.Mock).mockResolvedValue({ data: mockReports });
  ...
  describe('fetchReportDetails', () => {
    it('fetches report details successfully', async () => {
      // Mock successful API response
      (apiClient.get as vi.Mock).mockResolvedValue({ data: mockReportDetails });
  ...
  describe('fetchReportThread', () => {
    it('fetches report thread successfully', async () => {
      // Mock successful API response
      (apiClient.get as vi.Mock).mockResolvedValue({ data: mockReportThread });
  ...
  describe('submitReply', () => {
    it('submits reply successfully', async () => {
      // Mock successful API response
      (apiClient.post as vi.Mock).mockResolvedValue({ data: mockReplyResponse });
  ...
  describe('fetchMyReportsWithReplies', () => {
    it('fetches my reports with replies successfully', async () => {
      ...
      // Mock successful API response
      (apiClient.get as vi.Mock).mockResolvedValue({ data: mockReportsWithReplies });
  ...
  describe('fetchReportReplies', () => {
    it('fetches report replies successfully', async () => {
      ...
      // Mock successful API response
      (apiClient.get as vi.Mock).mockResolvedValue({ data: mockReplies });
