...
vi.mock('../AdminReportList', () => ({
  default: () => <div data-testid="admin-report-list">AdminReportList Component</div>
}));

vi.mock('../ReportRepliesList', () => ({
  default: () => <div data-testid="report-replies-list">ReportRepliesList Component</div>
}));

vi.mock('../ReportRepliedList', () => ({
  default: () => <div data-testid="report-replied-list">ReportRepliedList Component</div>
}));
