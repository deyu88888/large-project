...
vi.mock('../AdminEventList', () => ({
    default: () => _jsx("div", { "data-testid": "event-list", children: "EventList Component" })
}));
vi.mock('../RejectedEventsList', () => ({
    default: () => _jsx("div", { "data-testid": "event-list-rejected", children: "EventListRejected Component" })
}));
vi.mock('../PendingEventRequest', () => ({
    default: () => _jsx("div", { "data-testid": "pending-event-request", children: "PendingEventRequest Component" })
}));
...
describe('ManageEvents Component', () => {
    ...
    const renderManageEvents = async (useDarkTheme = false) => {
        return render(_jsx(ThemeProvider, { theme: useDarkTheme ? darkTheme : theme, children: _jsx(ManageEvents, {}) }));
    };
