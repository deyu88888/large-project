...
vi.mock('../../../components/Header', () => ({
    default: ({ title, subtitle }) => (_jsxs("div", { "data-testid": "header", children: [_jsx("div", { "data-testid": "header-title", children: title }), _jsx("div", { "data-testid": "header-subtitle", children: subtitle })] })),
}));
vi.mock('react-icons/fa', () => ({
    FaUsers: () => _jsx("div", { "data-testid": "users-icon" }),
    FaCalendarAlt: () => _jsx("div", { "data-testid": "calendar-icon" }),
    FaEnvelope: () => _jsx("div", { "data-testid": "envelope-icon" }),
}));
