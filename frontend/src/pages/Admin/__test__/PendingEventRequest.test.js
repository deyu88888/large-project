...
describe("PendingEventRequest Component", () => {
    ...
    it("renders the pending event requests", () => {
        ...
        useFetchWebSocket.mockReturnValue(mockEvents);
        render(_jsx(SearchContext.Provider, { value: { searchTerm: "" }, children: _jsx(PendingEventRequest, {}) }));
    ...
    it("filters events based on search term", () => {
        ...
        useFetchWebSocket.mockReturnValue(mockEvents);
        render(_jsx(SearchContext.Provider, { value: { searchTerm: "Event 1" }, children: _jsx(PendingEventRequest, {}) }));
        expect(screen.getByText("Event 1")).toBeInTheDocument();
    ...
    it("displays an alert when updateRequestStatus fails", async () => {
        ...
        useFetchWebSocket.mockReturnValue(mockEvents);
        updateRequestStatus.mockRejectedValue(new Error("Network Error"));
