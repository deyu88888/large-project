...
vi.mock('../../components/EventCalendar', async () => {
    return {
        default: function MockEventCalendar({ events }) {
            return _jsxs("div", { "data-testid": "mock-event-calendar", children: ["Events: ", events.length] });
        }
    };
});
vi.mock('../../components/UpcomingEvents', async () => {
    return {
        default: function MockUpcomingEvents({ events }) {
            return _jsxs("div", { "data-testid": "mock-upcoming-events", children: ["Events: ", events.length] });
        }
    };
});
vi.mock('../../components/PopularSocieties', async () => {
    return {
        default: function MockPopularSocieties() {
            return _jsx("div", { "data-testid": "mock-popular-societies", children: "Popular Societies" });
        }
    };
});
vi.mock('../../components/Sidebar', async () => {
    ...
    return {
        default: function MockSidebar(props) {
            return (_jsxs("div", { "data-testid": "mock-sidebar", children: [_jsx("button", { "data-testid": "toggle-dark-mode", onClick: props.onToggleDarkMode, children: "Toggle Dark Mode" }), _jsxs("div", { children: ["Width: ", props.sidebarWidth] })] }));
        }
    };
});
vi.mock('../../components/loading/loading-view', async () => {
    return {
        LoadingView: () => _jsx("div", { "data-testid": "mock-loading-view", children: "Loading..." })
    };
});
// Mock WebSocket
class MockWebSocket {
...
const renderDashboard = () => {
    return render(_jsx(BrowserRouter, { children: _jsx(Dashboard, {}) }));
};
