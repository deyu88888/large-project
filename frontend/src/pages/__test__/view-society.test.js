...
describe('ViewSociety Page', () => {
    ...
    const renderComponent = () => render(_jsx(ThemeProvider, { theme: theme, children: _jsx(MemoryRouter, { children: _jsx(ViewSociety, {}) }) }));
    it("displays a loading message initially and then renders society", async () => {
        ...
        await waitFor(() => expect(screen.getByText(/Robotics Club/i)).toBeInTheDocument());
