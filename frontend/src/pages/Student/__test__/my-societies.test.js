...
describe('MySocieties', () => {
    ...
    const renderComponent = (mode = 'light') => {
        ...
        return render(_jsx(ThemeProvider, { theme: theme, children: _jsx(MemoryRouter, { children: _jsx(MySocieties, {}) }) }));
    };
    ...
    it('logs an error and shows empty state when API call fails', async () => {
        ...
        apiClient.get.mockResolvedValueOnce(Promise.reject(new Error(errorMessage)));
