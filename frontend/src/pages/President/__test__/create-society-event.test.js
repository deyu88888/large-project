...
describe('CreateSocietyEvent Component', () => {
    ...
    function renderComponent() {
        return render(_jsx(MemoryRouter, { initialEntries: ['/society/123/create-event'], children: _jsx(Routes, { children: _jsx(Route, { path: "/society/:society_id/create-event", element: _jsx(CreateSocietyEvent, {}) }) }) }));
    }
