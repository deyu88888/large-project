...
describe('ManageSocietyEvents Component', () => {
    ...
    it('renders page title and initial loading state', async () => {
        render(_jsx(ThemeProvider, { theme: theme, children: _jsx(MemoryRouter, { initialEntries: ['/president-page/123/manage-society-events/upcoming'], children: _jsx(ManageSocietyEvents, {}) }) }));
        // Check main title
    ...
    it('renders correctly in dark mode', async () => {
        ...
        global.Date.now = () => mockDate.getTime();
        render(_jsx(ThemeProvider, { theme: darkTheme, children: _jsx(MemoryRouter, { initialEntries: ['/president-page/123/manage-society-events/upcoming'], children: _jsx(ManageSocietyEvents, {}) }) }));
