...
describe('EditEventDetails Component', () => {
    ...
    beforeEach(() => {
        vi.clearAllMocks();
        apiClient.get.mockResolvedValue({ data: mockEventDetail });
        apiClient.patch.mockResolvedValue({ data: { success: true } });
    });
    function renderComponent() {
        return render(_jsx(ThemeProvider, { theme: theme, children: _jsx(MemoryRouter, { initialEntries: [
                    `/president-page/${mockParams.society_id}/edit-event-details/${mockParams.event_id}`,
                ], children: _jsx(Routes, { children: _jsx(Route, { path: "/president-page/:society_id/edit-event-details/:event_id", element: _jsx(EditEventDetails, {}) }) }) }) }));
    }
