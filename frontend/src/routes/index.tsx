...
const ViewNotifications = lazy(
  () => import("../pages/Student/ViewNotifications")
);
...
const ManageSocietyDetails = lazy(
  () => import("../pages/President/ManageSocietyDetails")
);
const SocietyPreviewModal = lazy(
  () => import("../pages/President/SocietyPreviewModal")
);
const EditEventDetails = lazy(
  () => import("../pages/President/EditEventDetails")
);
const ManageSocietyEvents = lazy(
  () => import("../pages/President/ManageSocietyEvents")
);
const CreateEventPage = lazy(
  () => import("../pages/President/CreateSocietyEvent")
);
const ReportToAdmin = lazy(() => import("../pages/President/ReportToAdmin"));
const ViewSocietyMembers = lazy(
  () => import("../pages/President/ViewSocietyMembers")
);
...
const AssignRolePage = lazy(
  () => import("../pages/President/AssignSocietyRole")
);
...
const RequestDescriptionPage = lazy(
  () => import("../pages/Admin/SocietyDesChangeRequest")
);
        ...
        children: [
          {
            index: true,
            element: (
              <PageWithTitle title="Student Dashboard">
                <StudentDashboard />
              </PageWithTitle>
            ),
          },
          {
            path: "profile",
            element: (
              <PageWithTitle title="My Profile">
                <ProfilePage />
              </PageWithTitle>
            ),
          },
          {
            path: "my-societies",
            element: (
              <PageWithTitle title="My Societies">
                <MySocieties />
              </PageWithTitle>
            ),
          },
          {
            path: "view-events",
            element: (
              <PageWithTitle title="Upcoming Events">
                <ViewEvents />
              </PageWithTitle>
            ),
          },
          ...
          { path: "view-inbox", element: <ViewInbox /> },
          {
            path: "start-society",
            element: (
              <PageWithTitle title="Start a Society">
                <StartSociety />
              </PageWithTitle>
            ),
          },
          {
            path: "join-society",
            element: (
              <PageWithTitle title="Join a Society">
                <JoinSocietiesPage />
              </PageWithTitle>
            ),
          },
          ...
          },
          {
            path: "profile/:userId",
            element: (
              <PageWithTitle title="User Profile">
                <ProfilePage />
              </PageWithTitle>
            ),
          },
          {
            path: "report-thread/:reportId",
            element: (
              <PageWithTitle title="Report Thread">
                <ReportThread />
              </PageWithTitle>
            ),
          },
        ...
        children: [
          {
            index: true,
            element: (
              <PageWithTitle title="Society Management">
                <PresidentPage />
              </PageWithTitle>
            ),
          },
          ...
          },
          {
            ...
            element: (
              <PageWithTitle title="Society Events">
                <ManageSocietyEvents />
              </PageWithTitle>
            ),
          },
          {
            ...
            element: (
              <PageWithTitle title="Pending Members">
                <PendingMembers />
              </PageWithTitle>
            ),
          },
          {
            ...
            element: (
              <PageWithTitle title="Society Members">
                <ViewSocietyMembers />
              </PageWithTitle>
            ),
          },
          {
            path: "create-event",
            element: (
              <PageWithTitle title="Create Event">
                <CreateEventPage />
              </PageWithTitle>
            ),
          },
          {
            ...
            element: (
              <PageWithTitle title="Edit Event">
                <EditEventDetails />
              </PageWithTitle>
            ),
          },
          {
            path: "give-award/:memberId",
            element: (
              <PageWithTitle title="Give Award to Member">
                <GiveAwardPage />
              </PageWithTitle>
            ),
          },
          {
            path: "assign-role/:memberId",
            element: (
              <PageWithTitle title="Assign Society Role">
                <AssignRolePage />
              </PageWithTitle>
            ),
          },
        ...
        children: [
          {
            index: true,
            element: (
              <PageWithTitle title="Manage Society">
                <PresidentPage />
              </PageWithTitle>
            ),
          },
        ...
        children: [
          {
            index: true,
            element: (
              <PageWithTitle title="Manage Society Details">
                <ManageSocietyDetails />
              </PageWithTitle>
            ),
          },
        ...
        children: [
          {
            index: true,
            element: (
              <PageWithTitle title="Logging Out">
                <DashboardPage />
              </PageWithTitle>
            ),
          },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "event/:eventId",
        element: (
          <PageWithTitle title="Event Details">
            <EventDetailPage />
          </PageWithTitle>
        ),
      },
