 ...
 */
function getCloseEventCodeExplanation(code) {
    const explanations = {
...
class SocketConnectionManager {
    constructor() {
        ...
        Object.defineProperty(this, "status", {
            ...
            configurable: true,
            writable: true,
            value: CONNECTION_STATES.DISCONNECTED
        });
        Object.defineProperty(this, "supportedChannels", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "channelSubscribers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: {}
        });
        Object.defineProperty(this, "connectionAttempt", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "MAX_CONNECTION_ATTEMPTS", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 5
        ...
        Object.defineProperty(this, "channelListCallbacks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
    ...
    logWithTime(level, message, data) {
    ...
    subscribe(channel, callback) {
        ...
        const lastSubscriptionTime = this[lastSubscriptionKey] || 0;
        ...
        return () => {
            ...
            if (this.channelSubscribers[channel]) {
                ...
                this.channelSubscribers[channel] = this.channelSubscribers[channel].filter(cb => cb !== callback);
                ...
                if (this.channelSubscribers[channel].length === 0) {
                    ...
                    const lastUnsubscriptionTime = this[lastUnsubscriptionKey] || 0;
                    if (this.status === CONNECTION_STATES.AUTHENTICATED) {
                        ...
                        if (now - lastUnsubscriptionTime > 1000) {
                            if (this.safeSend(unsubscribeMsg)) {
                                ...
                                this[lastUnsubscriptionKey] = now;
                            }
                        }
                        else {
